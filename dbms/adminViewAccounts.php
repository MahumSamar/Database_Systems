                        ...
                        <form action="" method="POST">
                            <div class="signUpForm row">
                                    ...
                                    if ($result) {
                                        ...
                                        if (mysqli_num_rows($result) == 0) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                echo "<tr><td>" . $row['categoryName'] . "</td><td>" . $row['month'] . "</td><td>" . $row['noOfTimesServiceServed']
                                                    . "</td><td>" . $row['companyProfit'] . "</td><td>" . $row['earnedFromService'] . "</td></tr>";
                                            }
                                            echo "<br>";
                                            echo "</table>";
                                        }
                                ...
                                <table style="font-size: 30px;">
                                    ...
                                    <?php
                                    // to display electrician info
                                    $sql = "SELECT SUM(companyProfit) AS profit FROM AccountInfo ";
                                    ...
                                    if ($result) {
                                        ...
                                        if (mysqli_num_rows($result) == 0) {
                                            ...
                                            echo "No profit earned.";


                                            echo "<br>";
                                        } else {
                                            while ($row = $result->fetch_assoc()) {
                                                echo "<tr><td>" . $row['profit'] . "</td></tr>";
                                            }
                                            echo "<br>";
                                            echo "</table>";
                                        }
