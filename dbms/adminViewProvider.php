...
<head>
    ...
    <title>Admin View Provider</title>
    <style>
        table {
        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                ...
                <section class="sign_up_user">
                    <h1 class="title">providers Available</h1>
                        ...
                        <form action="" method="POST">
                            <div class="signUpForm row">
                                <table>
                                    ...
                                    $sql = "SELECT * FROM PersonInfo WHERE title = 'provider' ; ";
                                        ...
                                        // if(){
                                            if (mysqli_num_rows($result) == 0) {
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    echo "<tr><td>" . $row['personID'] . "</td><td>" . $row['email'] . "</td><td>" . $row['firstName'] . " " . $row['lastName']
                                                . "</td><td>" . $row['cnic'] .  "</td><td>" . $row['phone'] .  "</td><td>" . $row['address'] .
