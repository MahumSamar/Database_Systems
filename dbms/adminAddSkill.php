...
$sql = "INSERT INTO Skills (categoryID,skillName) VALUES (?,?)";
$stmt = $conn -> prepare( $sql);
if ($stmt) {
    // the ssssss here are for representing the type of the parameters passed
    $stmt -> bind_param("ss", $categoryID,$skillName);
    ...
    if ($stmt -> execute()) {
        ...
        header("location: adminAddSkill.php");
    }
        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                ...
                <section class="sign_up_user">
                    <h1 class="title">Categories available  </h1>
                    ...
                    <div class="container">
                        <form action="" method="POST">
                            ...
                            <table>
                                ...
                                <div class="my-4">
                                <h1 class="title">Skills Available</h1></div> 
                                ...
                                <table>
                                    ...
                                    <?php
                                    // to display electrician info
                                    $sql = "SELECT categoryName, skillID, skillName
                                    FROM Category c,
                                         Skills s
                                    ...
                                    if ($result) {
                                        ...
                                        // if(){
                                            if (mysqli_num_rows($result) == 0) {
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    echo "<tr><td>" . $row['categoryName']  .  "</td><td>" . $row['skillID'] .  "</td><td>" . $row['skillName'] . "</td></tr>";
                                                }
                                                echo "<br>";
                                                echo "</table>";
                                ...
                                <h1 class="title" style="font-size: 35px;">Select category id</h1>
                                </div>
                               

                                <?php
                                    // to select provider id from combo box
                                    $sql = "SELECT categoryID FROM Category WHERE NOT categoryID = 1 ";
                                ...
                                <div class="formField col-lg-12">
                                    <input id="skillName" class="input-text" type="text" name="skillName" required>
                                    <label for="skillName" class="label">Skill Name</label>
                                </div>
